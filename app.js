...
let nothing = undefined; // used for functions that do not return a value
...
class Animal extends mammal {
    constructor(nameArg, ageArg, hasHairArg, isWarmBloodedArg) {
...
//
let dog = new Animal("Joe", 5, true, true);
//Type Assertion
...
let messageLength = message.length; // angle brackets syntax
let alterMessageLength = message.length; // "as" syntax
